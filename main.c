...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        if (IsKeyPressed.RIGHT) player.cell.x++;
        else if (IsKeyPressed.LEFT) player.cell.x--;
        else if (IsKeyPressed.UP) player.cell.y--;
        else if (IsKeyPressed.DOWN) player.cell.y++;
